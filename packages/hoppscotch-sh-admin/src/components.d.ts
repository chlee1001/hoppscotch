...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    UsersGroupsAddMembersModal: typeof import('./components/users/groups/AddMembersModal.vue')['default']
    UsersGroupsAssignTeamsModal: typeof import('./components/users/groups/AssignTeamsModal.vue')['default']
    UsersGroupsAuditLog: typeof import('./components/users/groups/AuditLog.vue')['default']
    UsersGroupsCreateModal: typeof import('./components/users/groups/CreateModal.vue')['default']
    UsersGroupsDetails: typeof import('./components/users/groups/Details.vue')['default']
    UsersGroupsEditModal: typeof import('./components/users/groups/EditModal.vue')['default']
    UsersGroupsMembers: typeof import('./components/users/groups/Members.vue')['default']
    UsersGroupsTeams: typeof import('./components/users/groups/Teams.vue')['default']
